...
function formatStyledReminderLine(ctx: ExtensionContext, label: string, value: string): string {
	const styledLabel = ctx.ui.theme.fg("muted", ctx.ui.theme.bold(label.padEnd(LABEL_WIDTH)));
